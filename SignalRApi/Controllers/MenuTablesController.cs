...
namespace SignalRApi.Controllers
{
    ...
    public class MenuTablesController : ControllerBase
    {
        ...
        [HttpPut]
        public IActionResult UpdateMenuTable(UpdateMenuDto updateMenuDto)
        {
            updateMenuDto.Status = false;
            var value = _mapper.Map<MenuTable>(updateMenuDto);
        ...
        public IActionResult ChangeMenuTableStatusToTrue(int id)
        {
            ...
            return Ok("Masa Durumu Aktif Edildi");
        }
        ...
        public IActionResult ChangeMenuTableStatusToFalse(int id)
        {
            ...
            return Ok("Masa Durumu Pasif Edildi");
        }
    }
}
