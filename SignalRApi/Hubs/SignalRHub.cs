...
namespace SignalRApi.Hubs
{
    public class SignalRHub:Hub
    {
        ...
        public async Task SendStatistic()
        {
            ...
            await Clients.All.SendAsync("ReceiveTProductCountByCategoryNameHamburger", value5);
            ...
            await Clients.All.SendAsync("ReceiveTProductAvgPriceByHamburger", value10.ToString("0.00") + "₺");
        ...
        public async Task SendNotification()
        {
            ...
            await Clients.All.SendAsync("ReceiverNotificationListByFalse", notificationListByFalse);
        }
